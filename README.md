...
<script>
  ...
  var smd = new SMD4();
  console.log(document.getElementById("main_content").innerText);
  document.getElementById("main_content").innerHTML=smd.run(document.getElementById("main_content").innerHTML);
</script>
