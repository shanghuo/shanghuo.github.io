...
## 上火的个人站
上火的个人站存放于github，由于一些原因，在通过部分运营商的线路进行访问时，经常出现稀奇古怪的错误，这些错误总是不时的发生，并在数次刷新后恢复。如果您无法访问，请等待10分钟左右重试。

## 山岚幽阳
山岚幽阳(上火的学习交流平台)存放于阿里云，但由于SRP是单线程程序，在返回图片时存在一些性能问题，因而图片加载较慢。后续将考虑改变图库位置，或优化程序逻辑，改变运作方式等，来逐步解决这个问题。但是，由于现目前访问量极低，暂时还需要一段时间，才会抽出时间，着手去处理这个问题。
